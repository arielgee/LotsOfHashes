...
// CSha512Sha384.cpp : implementation file
//

/////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                         //
// Sha512Sha384 - Implementation of the Secure SHA384 and SHA512 Algorithms.               //
//                                                                                         //
...
#define ROUND(a,b,c,d,e,f,g,h,k,data) do {		\
  UINT64 T1 = h + S1(e) + Choice(e,f,g) + k + data;	\
  d += T1;						\
...
#define STRING2INT64(s) ((((((((((((((UINT64)(EXTRACT_UCHAR(s) << 8)    \
			 | EXTRACT_UCHAR(s+1)) << 8)  \
			 | EXTRACT_UCHAR(s+2)) << 8)  \
			 | EXTRACT_UCHAR(s+3)) << 8)  \
			 | EXTRACT_UCHAR(s+4)) << 8)  \
...
/////////////////////////////////////////////////////////////////////
//
CSha512Sha384::CSha512Sha384(void)
{
}
...
/////////////////////////////////////////////////////////////////////
// Initialize the SHA512 values
void CSha512Sha384::Init512(sha512_sha384_ctx* ctx)
{
  /* Initial values */
	static const UINT64 H0[_SHA512_SHA384_STATE_LENGTH] = {
...
/////////////////////////////////////////////////////////////////////
// Initialize the SHA384 values
void CSha512Sha384::Init384(sha512_sha384_ctx* ctx)
{
  /* Initial values */
	static const UINT64 H0[_SHA512_SHA384_STATE_LENGTH] = {
...
/////////////////////////////////////////////////////////////////////
//
void CSha512Sha384::Update(sha512_sha384_ctx* ctx, const UINT8* data, UINT32 length)
{
	UINT32 left;
...
void CSha512Sha384::Final(sha512_sha384_ctx* ctx)
{
	UINT64 data[SHA512_SHA384_DATA_LENGTH];
	UINT32 i;
	UINT32 words;
...
/////////////////////////////////////////////////////////////////////
//
void CSha512Sha384::Digest512(const sha512_sha384_ctx* ctx, UINT8 *digest)
{
	this->digest(ctx, digest, SHA512_DIGEST_SIZE / 8);
}

/////////////////////////////////////////////////////////////////////
//
void CSha512Sha384::Digest384(const sha512_sha384_ctx* ctx, UINT8 *digest)
{
	this->digest(ctx, digest, SHA384_DIGEST_SIZE / 8);
}
...
void CSha512Sha384::transform(UINT64* state, UINT64* data)
{
	UINT64 A, B, C, D, E, F, G, H;	/* Local vars */
	UINT8 i;
	const UINT64 *k;
	UINT64 *d;
...
/////////////////////////////////////////////////////////////////////
//
void CSha512Sha384::block(sha512_sha384_ctx* ctx, const UINT8* block)
{
	UINT64 data[SHA512_SHA384_DATA_LENGTH];
	UINT32 i;
...
/////////////////////////////////////////////////////////////////////
//
void CSha512Sha384::digest(const sha512_sha384_ctx* ctx, UINT8* s, UINT32 len)
{
	UINT32 i;
