...
static const UINT32 crc32_table_b[256] =
{
...
/////////////////////////////////////////////////////////////////////
//
CCrc32::CCrc32(void) : m_dwCrc32(0xFFFFFFFF)
{	
}
...
/////////////////////////////////////////////////////////////////////
//
bool CCrc32::Update(BYTE bData)
{	
	try
	{
		m_dwCrc32 = (m_dwCrc32 << 8) ^ crc32_table[bData ^ (m_dwCrc32 >> 24)];
	}
	catch(...)
	{
		return false;
...
/////////////////////////////////////////////////////////////////////
//
bool CCrc32::Update_b(BYTE bData)
{	
	try
	{
		m_dwCrc32 = (m_dwCrc32 >> 8) ^ crc32_table_b[bData ^ (m_dwCrc32 & 0x000000FF)];
	}
	catch(...)
	{
		return false;
...
/////////////////////////////////////////////////////////////////////
//
UINT32 CCrc32::Digest()
{
	return (m_dwCrc32 = ~m_dwCrc32);
}