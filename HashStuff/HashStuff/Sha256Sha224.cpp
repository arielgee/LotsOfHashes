...
// CSha256Sha224.cpp : implementation file
//

/////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                         //
// Sha224Sha256 - Implementation of the Secure SHA224 and SHA256 Algorithms.               //
//                                                                                         //
...
#define ROUND(a,b,c,d,e,f,g,h,k,data) do {		\
  UINT32 T1 = h + S1(e) + Choice(e,f,g) + k + data;	\
  d += T1;						\
...
/////////////////////////////////////////////////////////////////////
//
CSha256Sha224::CSha256Sha224(void)
{
}
...
void CSha256Sha224::Init224(sha256_sha224_ctx* ctx)
{
	/* Initial values, copied from fips180-2. */
	static const UINT32 H0[_SHA256_SHA224_DIGEST_LENGTH] = {
...
/////////////////////////////////////////////////////////////////////
// Initialize the SHA values
void CSha256Sha224::Init256(sha256_sha224_ctx* ctx)
{
...
/////////////////////////////////////////////////////////////////////
//
void CSha256Sha224::Update(sha256_sha224_ctx* ctx, const UINT8* data, UINT32 length)
{
	UINT32 left;
...
void CSha256Sha224::Final(sha256_sha224_ctx* ctx)
{
	UINT32 data[SHA256_SHA224_DATA_LENGTH];
	UINT32 i;
	UINT32 words;
...
/////////////////////////////////////////////////////////////////////
//
void CSha256Sha224::Digest224(const sha256_sha224_ctx* ctx, UINT8* digest)
{
	this->digest(ctx, digest, SHA224_DIGEST_SIZE / 4);
}

/////////////////////////////////////////////////////////////////////
//
void CSha256Sha224::Digest256(const sha256_sha224_ctx* ctx, UINT8* digest)
{
	this->digest(ctx, digest, SHA256_DIGEST_SIZE / 4);
}
...
void CSha256Sha224::transform(UINT32* state, UINT32* data)
{
	UINT32			A, B, C, D, E, F, G, H;	/* Local vars */
	UINT8				i;
	const UINT32*	k;
	UINT32*			d;
...
/////////////////////////////////////////////////////////////////////
// 
void CSha256Sha224::block(sha256_sha224_ctx* ctx, const UINT8* block)
{
	UINT32 data[SHA256_SHA224_DATA_LENGTH];
	UINT32 i;
...
/////////////////////////////////////////////////////////////////////
// 
void CSha256Sha224::digest(const sha256_sha224_ctx* ctx, UINT8* s, UINT32 len)
{
	UINT32 i;
