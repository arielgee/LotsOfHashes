...
// Ripemd.cpp : implementation file
//
...
#define EXTRACT_UCHAR(p)  (*(UINT8*)(p))
...
/////////////////////////////////////////////////////////////////////
//
void CRipemd::Init128(ripemd_ctx* ctx)
{
  init(ctx);
...
/////////////////////////////////////////////////////////////////////
//
void CRipemd::Init160(ripemd_ctx* ctx)
{
  init(ctx);
  ctx->digest[4] = h4init;
...
/////////////////////////////////////////////////////////////////////
//
void CRipemd::Init256(ripemd_ctx* ctx)
{
  init(ctx);
  ctx->digest[4] = h5init;
  ctx->digest[5] = h6init;
...
/////////////////////////////////////////////////////////////////////
//
void CRipemd::Init320(ripemd_ctx* ctx)
{
  init(ctx);
  ctx->digest[4] = h4init;
  ctx->digest[5] = h5init;
...
/////////////////////////////////////////////////////////////////////
//
void CRipemd::Update(ripemd_ctx* ctx, UINT8* buffer, UINT32 len)
{
...
/////////////////////////////////////////////////////////////////////
//
void CRipemd::Digest(ripemd_ctx* ctx, UINT8* s)
{
	this->final(ctx);
...
void CRipemd::init(ripemd_ctx* ctx)
{
...
/////////////////////////////////////////////////////////////////////
// 
void CRipemd::transform(ripemd_ctx* ctx, UINT32* data)
{
switch(ctx->digest_len)  /* select the right compression function */
    {
    case 8 * RIPEMD128_DIGESTSIZE: 
      transform128(ctx, data); break;
    case 8 * RIPEMD160_DIGESTSIZE: 
      transform160(ctx, data); break;
    case 8 * RIPEMD256_DIGESTSIZE: 
      transform256(ctx, data); break;
    case 8 * RIPEMD320_DIGESTSIZE: 
      transform320(ctx, data); break;
    }
}

/////////////////////////////////////////////////////////////////////
// 
void CRipemd::transform128(ripemd_ctx* ctx, UINT32* data)
{
	UINT32 A, B, C, D;	/* Local vars */
	UINT32 AA, BB, CC, DD;	/* Local vars */
	UINT32 T;
...
/////////////////////////////////////////////////////////////////////
// 
void CRipemd::transform160(ripemd_ctx* ctx, UINT32* data)
{
	UINT32 A, B, C, D, E;   	/* Local vars */
	UINT32 AA, BB, CC, DD, EE;      /* Local vars */
	UINT32 T;
...
/////////////////////////////////////////////////////////////////////
// 
void CRipemd::transform256(ripemd_ctx* ctx, UINT32* data)
{
	UINT32 A, B, C, D;	/* Local vars */
	UINT32 AA, BB, CC, DD;	/* Local vars */
	UINT32 T;
...
/////////////////////////////////////////////////////////////////////
// 
void CRipemd::transform320(ripemd_ctx* ctx, UINT32* data)
{
	UINT32 A, B, C, D, E;   	/* Local vars */
	UINT32 AA, BB, CC, DD, EE;      /* Local vars */
	UINT32 T;
...
/////////////////////////////////////////////////////////////////////
// 
void CRipemd::block(ripemd_ctx* ctx, UINT8* block)
{
	UINT32 data[RIPEMD_DATALEN];
	UINT32 i;
...
void CRipemd::final(ripemd_ctx* ctx)
{
	UINT32 data[RIPEMD_DATALEN];
	UINT32 i;
	UINT32 words;
